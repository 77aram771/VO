...
import {LikedVideo} from "../../../components/UI/LikedVideos"
...
export const LikedVideos = ({navigation}) => {
            ...
            <View style={style.container}>
                ...
                >
                    <FlatList
                        ...
                        renderItem={({ item, index }) => (<LikedVideo item={item} parentMoreClick={handlePopup} />)}
                    />
                </ScrollView>
            </View>
        </TouchableWithoutFeedback>
